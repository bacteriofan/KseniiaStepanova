...
public class SimpleTestOnlyRegression {

    @Test(groups = "Regression")
    public void simpleSeleniumTestRegression1() {
    ...
    @Test(groups = "Regression")
    public void simpleSeleniumTestRegression2() {
        WebDriver driver = new ChromeDriver();
        driver.manage().window().maximize();
    ...
    @Test(groups = "Regression")
    public void simpleSeleniumTestRegression3() {
        WebDriver driver = new ChromeDriver();
        driver.manage().window().maximize();
