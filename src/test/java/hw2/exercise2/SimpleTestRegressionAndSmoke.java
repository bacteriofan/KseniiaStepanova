...
public class SimpleTestRegressionAndSmoke {

    @Test(groups = "Regression")
    public void simpleSeleniumTestRegression4() {
    ...
    @Test(groups = "Regression")
    public void simpleSeleniumTestRegression5() {
        WebDriver driver = new ChromeDriver();
        driver.manage().window().maximize();
    ...
    @Test(groups = "Smoke")
    public void simpleSeleniumTestSmoke4() {
        WebDriver driver = new ChromeDriver();
        driver.manage().window().maximize();
